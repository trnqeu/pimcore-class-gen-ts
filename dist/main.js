...
const fieldSpecs = records.map((record) => {
    ...
    return {
        ...
        listValues: record['List Values'] ? record['List Values'].split(';').map((v) => v.trim()) : [],
...
class PimcoreClassGenerator {
    ...
    addFieldToContainer(containerName, field) {
    ...
    createTextareaField(definition) {
        return {
            name: '',
            title: '',
            tooltip: '',
    ...
    createLocalizedFields(definition) {
        return {
    ...
    createImageGalleryField(definition) {
        return {
            name: '',
            title: '',
            tooltip: '',
    ...
    createManyToManyRelationField(definition) {
        return {
            name: '',
            title: '',
            tooltip: '',
